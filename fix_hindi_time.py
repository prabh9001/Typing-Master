...
# Fix the Hindi file specifically
file_path = r'c:\Users\WAHEGURU JI\Desktop\New folder (2)\lessons_hindi.html'
...
pattern = r'(<div><strong>Errors:</strong>\s*<span id="err-(hindi_\d+)">-</span></div>)\s*</div>\s*</div>'
...
print(f"Fixed Hindi file - added time fields")
